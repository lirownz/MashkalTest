...
public class testHeaderSanity {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		//****title comparing
		WebElement aoaPageTitle = driver.findElement(By.xpath("/html/body/div[5]/div/div/div/h1"));
		...
		//*** text wanted to be compare to
		String expectedURL1 = "https://webapp-front-test-mashcal.azurewebsites.net/areas-of-activity/?categoryId=4263";
		...
		////////////Construction & Infrastructure page 2
		//***** moving back to home page (site symbol clicking)
		driver.findElement(By.xpath("/html/body/header/nav/div/a/img")).click();
		System.out.println("redirecting back to home page");
		Thread.sleep(1000);
		...
		//*** text wanted to be compare to
		String expectedURL2 = "https://webapp-front-test-mashcal.azurewebsites.net/areas-of-activity/?categoryId=2424";
		...
		//*** text wanted to be compare to
		String expectedURL3 = "https://webapp-front-test-mashcal.azurewebsites.net/areas-of-activity/?categoryId=2440";
		...
		//*** text wanted to be compare to
		String expectedURL4 = "https://webapp-front-test-mashcal.azurewebsites.net/areas-of-activity/?categoryId=2442";
		...
		//*** text wanted to be compare to
		String expectedURL5 = "https://webapp-front-test-mashcal.azurewebsites.net/areas-of-activity/?categoryId=3143";
		...
		//*** text wanted to be compare to
		String expectedURL7 = "https://webapp-front-test-mashcal.azurewebsites.net/areas-of-activity/?categoryId=2593";
		...
		/////////// construction and infrastructure tenders page 7
		//***** moving back to home page (site symbol clicking)
		driver.findElement(By.xpath("/html/body/header/nav/div/a/img")).click();
		System.out.println("redirecting back to home page");
		Thread.sleep(1000);
		...
		//*** Areas of activity dropdown -  clicking on "construction and infrastructure"  	
		...
		//****title comparing
		WebElement caiPageTitle = driver.findElement(By.xpath("/html/body/div[5]/div/div/div/h1"));
		String caiTitleString = caiPageTitle.getText();
		caiPageTitle.click();
		Thread.sleep(1000);
		System.out.println(caiTitleString);

		//*** text wanted to be compare to
		String expectedTitle7 = "בנייה ושיפוצים";
		System.out.println(expectedTitle7);
		Thread.sleep(2000);

		//***** Using Collector and Locale  for non English Text encode (change text to English encode)
		Collator caiCollator = Collator.getInstance(Locale.ENGLISH);
		caiCollator.setStrength(Collator.PRIMARY);

		//***** Comparing between the two Strings
		if (aoaCollator.compare(caiTitleString, expectedTitle7) == 0) {
			System.out.println("##  PASS - page Title is Equal  ##");
		} else {
			System.out.println("##  FAIL - page Title is NOT Equal  ##");
		}
		...
		//****title comparing
		WebElement auPageTitle = driver.findElement(By.xpath("/html/body/div[5]/div[1]/div/div/h1"));
		...
		//////About Us page 1 - board directors
		//***** moving back to home page (site symbol clicking)
		driver.findElement(By.xpath("/html/body/header/nav/div/a/img")).click();
		System.out.println("redirecting back to home page");
		Thread.sleep(1000);
		...
		System.out.println("moving to board directors page");
		Thread.sleep(2000);

		//****title comparing
		WebElement bdPageTitle = driver.findElement(By.xpath("/html/body/div[5]/div[1]/div/div/h1"));
		String bdTitleString = bdPageTitle.getText();
		bdPageTitle.click();
		Thread.sleep(1000);
		System.out.println(bdTitleString);

		//*** text wanted to be compare to
		String expectedTitleBD = "חברי דירקטוריון";
		System.out.println(expectedTitleBD);
		Thread.sleep(2000);

		//***** Using Collector and Locale  for non English Text encode (change text to English encode)
		Collator bdCollator = Collator.getInstance(Locale.ENGLISH);
		bdCollator.setStrength(Collator.PRIMARY);

		//***** Comparing between the two Strings
		if (auCollator.compare(bdTitleString, expectedTitleBD) == 0) {
			System.out.println("##  PASS - page Title is Equal  ##");
		} else {
			System.out.println("##  FAIL - page Title is NOT Equal  ##");
		}
		...
		//****title comparing
		WebElement coPageTitle = driver.findElement(By.xpath("/html/body/div[5]/div[1]/div/div/h1"));
		String coTitleString = coPageTitle.getText();
		coPageTitle.click();
		Thread.sleep(1000);
		System.out.println(coTitleString);

		//*** text wanted to be compare to
		String expectedTitleCO = "נהלי הצעות מחיר";
		System.out.println(expectedTitleCO);
		Thread.sleep(2000);

		//***** Using Collector and Locale  for non English Text encode (change text to English encode)
		Collator coCollator = Collator.getInstance(Locale.ENGLISH);
		coCollator.setStrength(Collator.PRIMARY);

		//***** Comparing between the two Strings
		if (coCollator.compare(coTitleString, expectedTitleCO) == 0) {
			System.out.println("##  PASS - page Title is Equal  ##");
		} else {
			System.out.println("##  FAIL - page Title is NOT Equal  ##");
		}
		...
		////// Ministry of the Interior page 3
		//***** moving back to home page (site symbol clicking)
		driver.findElement(By.xpath("/html/body/header/nav/div/a/img")).click();
		System.out.println("redirecting back to home page");
		Thread.sleep(1000);
		...
		//****title comparing
		WebElement miPageTitle = driver.findElement(By.xpath("/html/body/div[5]/div[1]/div/div/h1"));
		...
		//****title comparing
		WebElement lapPageTitle = driver.findElement(By.xpath("/html/body/div[5]/div[1]/div/div/h1"));
		...
		//****title comparing
		WebElement obPageTitle = driver.findElement(By.xpath("/html/body/div[5]/div[1]/div/div/h1"));
		...
		//*** text wanted to be compare to
		String expectedTitleOB = "בלוג משכל";
		...
		//****title comparing
		WebElement pageTitleElement = driver.findElement(By.xpath("/html/body/div[5]/div[1]/div/div/h1"));
		...
		//////**** entering the wanted page - sending form
		driver.findElement(By.xpath("/html/body/div[6]/div[3]/div/div[1]/a[2]/div")).click();
		Thread.sleep(1000);
		System.out.println("first page is opened");
		...
		//
		//		//*** text wanted to be compare to
		//		String expectedTitle2 = "מכרז לתכנון ובניית קירויי�? למגרשי ספורט";
		...
		try {
			WebElement page = driver.findElement(By.xpath("/html/body/div[6]/div[1]/div[1]/div/div[1]/div[1]/div[6]/button/span[2]"));
			...
			System.out.println("tender sheet is opened");
			Thread.sleep(2000);
			...
			System.out.println("closing the Tender Sheet");
			driver.findElement(By.xpath("/html/body/div[6]/div[2]/div/div/div[1]/button/span")).click();
			Thread.sleep(2000);
			System.out.println("Tender Sheet - closed");
		}
		catch (Exception e) {
			System.out.println("Tender is not open yet");
		}
		Thread.sleep(2000);
		...
		//****title comparing
		WebElement pageTitleElement3 = driver.findElement(By.xpath("/html/body/div[5]/div[1]/div/div/h1"));
		...
		subjectList.selectByValue("uri.cohen@ewave.co.il");
		Thread.sleep(1000);
